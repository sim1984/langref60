...
.Отзыв табличных привилегий у пакета (для упакованных временных таблиц)
[example]
====
[source,sql]
----
revoke select, insert on package pkg from user some_user;
----
====
...
-- Отзыв привилегии USAGE на пакет APP_VAR из схемы APP
-- для всех пользователей
REVOKE USAGE ON PACKAGE APP.APP_VAR FROM PUBLIC;
----
====
