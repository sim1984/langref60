...
|subroutines
|Одна или несколько объявленных локальных переменных, курсоров, процедур или функций.
...
`<subroutines>`:: Стандартные объявления функций или процедур PSQL. Здесь же можно объявлять локальные переменные и курсоры.
