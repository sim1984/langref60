...
[listing,subs="+quotes,attributes"]
----
INSERT INTO \[__schema-name__.]_target_ [(<column_list>)]
...
<output_column> ::=
    \[__schema-name__.]_target_.*
  | <return_expression> [COLLATE [_schema-name_.{endsb}__collation__] [[AS] _alias_]

<return_expression> ::=
    <value_expression>
  | [[_schema-name_.] _target_.{endsb}__col_name__
...
[listing,subs="+quotes,attributes"]
----
UPDATE \[__schema-name__.]_target_ [[AS] _alias_]
...
<output_column> ::=
    \[__schema-name__.]_target_.*
  | NEW.* | OLD.*
  | <return_expression> [COLLATE [_schema-name_.{endsb}_collation_] [[AS] _ret_alias_]

<return_expression> ::=
    <value_expression>
  | [[_schema-name_.{endsb}__target__.{endsb}__col_name__
  | NEW._col_name_
  | OLD._col_name_
...
[listing,subs="+quotes,attributes"]
----
UPDATE OR INSERT INTO \[__schema-name__.]_target_ [(<column_list>)]
  VALUES (<value_list>)
...
----
DELETE
  FROM \[__schema-name__.]_target_ [[AS] _alias_]
  [WHERE {<search-conditions> | CURRENT OF _cursorname_}]
  [PLAN <plan_items>]
  [ORDER BY <sort_items>]
  [ROWS _m_ [TO _n_]]
...
<output_column> ::=
    \[__schema-name__.]_target_.*
  | <return_expression> [COLLATE [_schema-name_.{endsb}__collation__] [[AS] _ret_alias_]
...
----
MERGE
  INTO \[__schema-name__.]_target_ [[AS] _target_alias_]
...
<source> ::= \[__schema-name__.]_tablename_ | (<select_stmt>)
...
----
<execute procedure> ::=
    EXECUTE PROCEDURE [_schema-name_.]\[__package-name__.]_procedure-name_
    [{ (<arguments>) | <arguments> }]
...
----
<call statement> ::=
    CALL [_schema-name_.]\[__package-name__.]_procedure-name_ (<arguments>)
