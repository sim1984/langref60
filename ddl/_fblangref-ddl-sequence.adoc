...
Если перед именем последовательности указана схема, то последовательность будет создана в указанной схеме, в противном случае последовательность будет создана в текущей схеме.
