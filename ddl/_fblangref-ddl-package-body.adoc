...
Константы объявленные в заголовке пакета, не могут быть повторно объявлены в теле пакета.

Имена процедур, функций и констант, объявленные в теле пакета, должны быть уникальны среди имён процедур, функций и констант, объявленных в заголовке и теле пакета.
