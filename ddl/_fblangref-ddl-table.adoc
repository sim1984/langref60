...
* Глобальные временные таблицы (`GLOBAL TEMPORARY TABLE` или GTT);
* Виртуальные (в основном таблицы мониторинга `MON$`);
* Внешние (EXTERNAL). Описаны в <<fblangref_ddl_table_ext>>.
