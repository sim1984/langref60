...
----
CREATE TRIGGER [IF NOT EXISTS] \[__schema-name__.]_trigname_ {
...
[listing,subs="+quotes,macros"]
----
ALTER TRIGGER \[__schema-name__.]_trigname_
[ACTIVE | INACTIVE]
[{BEFORE | AFTER} <mutation_list>]
[POSITION number]
...
[listing,subs="+quotes,macros"]
----
CREATE OR ALTER TRIGGER \[__schema-name__.]_trigname_ {
    <relation_trigger_legacy>
  | <relation_trigger_sql2003>
  | <database_trigger>
  | <ddl_trigger> }
...
[listing,subs="+quotes"]
----
DROP TRIGGER [IF EXISTS] \[__schema-name__.]_trigname_
----
...
[listing,subs="+quotes,macros"]
----
RECREATE TRIGGER \[__schema-name__.]_trigname_ {
    <relation_trigger_legacy>
  | <relation_trigger_sql2003>
  | <database_trigger>
  | <ddl_trigger> }
