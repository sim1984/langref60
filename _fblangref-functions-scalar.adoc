...
Данная функция является совместимым с SQL-стандартом псевдонимом функции <<fblangref-scalarfuncs-maxvalue>>.
...
Данная функция является совместимым с SQL-стандартом псевдонимом функции <<fblangref-scalarfuncs-minvalue>>.
