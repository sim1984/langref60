...
[listing,subs=+quotes]
----
LIST([ALL | DISTINCT] <expr> [, _separator_]) [ <listagg overflow clause> ] [ <within group specification> ]

LISTAGG([ALL | DISTINCT] <expr> [, _separator_]) [ <listagg overflow clause> ] [ <within group specification> ]
