...
Предоставляет информация об активных локальных временных таблицах (LTT) для всех соединений.
...
Предоставляет информация о столбцах активных локальных временных таблицах (LTT) для всех соединений.
